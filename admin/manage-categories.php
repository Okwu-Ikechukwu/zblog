...
<section class="dashboard">
    ...
    <?php elseif(isset($_SESSION['add-category'])) : // shows if add category was unsuccessful?>
    ...
    <?php elseif(isset($_SESSION['edit-category'])) : // shows if edit category was unsuccessful?>
        <div class="alert-message error container">
            <p>
